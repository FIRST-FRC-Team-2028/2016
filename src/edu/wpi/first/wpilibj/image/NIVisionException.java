 ...
 * @author dtjones
 */
@objid ("57528a1d-0d15-42e6-aa37-e618f6de578b")
public class NIVisionException extends Exception {
     ...
     */
    @objid ("870296a8-e72e-4468-a5d9-1983342592b5")
     ...
     */
    @objid ("bf5e0109-9047-4e37-8e31-19a8aec32f14")
    public NIVisionException(int errorCode) {
        super(lookUpCode(errorCode));
    }

    @objid ("c15e0f30-885d-43c5-b39a-4f8c03e4e11f")
